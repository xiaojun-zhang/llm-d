...
model="${AUDIT_MODEL:-/mnt/weka/data/llm-d-models-pv/hub/models--moonshotai--Kimi-VL-A3B-Instruct/snapshots/main}"
result_root="${RESULT_ROOT:-${REPO_ROOT}/testing/results/llm_d_kimivla3b_semantic_audit_${timestamp}}"
